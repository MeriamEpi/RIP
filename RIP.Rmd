...
ggplotly(p, config = list(displayModeBar = TRUE)) %>% layout(annotations=list(x = 1, y = -0.1, text ="Data courtesy of US Bureau of Labour Statistics", showarrow = F, xref='paper', yref='paper', xanchor='right', yanchor='auto', xshift=0, yshift=0, font=list(size=8)), xaxis = list(rangeslider = list(visible=FALSE)))
...
![](~/R repo/docs/Presentation1.png){width=850px}

## DAG
![](~/R repo/docs/DAG.jpg){width=850px}
...
<div class="container">
  <img src="~/R repo/docs/Table 0.jpg" width="700px"/>
</div>
